...
.response([Location], 'A list of locations.')
...
.body(Location, 'The location to create.')
.response(201, Location, 'The created location.')
.error(HTTP_CONFLICT, 'The location already exists.')
...
.response(Location, 'The location.')
...
.pathParam('key', keySchema)
.body(Location, 'The data to replace the location with.')
.response(Location, 'The new location.')
...
.pathParam('key', keySchema)
.body(joi.object().description('The data to update the location with.'))
.response(Location, 'The updated location.')
